...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference("Publication.count") do
      post publications_url, params: { publication: { cargo: @publication.cargo, detalle: @publication.detalle, user_id: @publication.user_id } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { cargo: @publication.cargo, detalle: @publication.detalle, user_id: @publication.user_id } }
